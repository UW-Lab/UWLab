...
.. _documentation: https://uw-lab.github.io/UWLab/source/setup/developer.html#extension-dependency-management
"""
...
def install_apt_packages(paths: list[str]):
    """Installs apt packages listed in the extension.toml file for UW Lab extensions.
...
def install_rosdep_packages(paths: list[str], ros_distro: str = "humble"):
    """Installs ROS dependencies listed in the extension.toml file for UW Lab extensions.
