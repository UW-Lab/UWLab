...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_cfg:AnymalCRoughPPORunnerFlatCfg",
...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_cfg:AnymalCRoughPPORunnerCfg",
