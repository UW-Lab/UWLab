...
if TYPE_CHECKING:
    from . import basic_mesh_terrains_cfg


def flat_terrain(
    difficulty: float, cfg: basic_mesh_terrains_cfg.MeshPlaneTerrainCfg
...
def pyramid_stairs_terrain(
    difficulty: float, cfg: basic_mesh_terrains_cfg.MeshPyramidStairsTerrainCfg
) -> tuple[list[trimesh.Trimesh], np.ndarray]:
...
def inverted_pyramid_stairs_terrain(
    difficulty: float, cfg: basic_mesh_terrains_cfg.MeshInvertedPyramidStairsTerrainCfg
) -> tuple[list[trimesh.Trimesh], np.ndarray]:
...
def random_grid_terrain(
    difficulty: float, cfg: basic_mesh_terrains_cfg.MeshRandomGridTerrainCfg
) -> tuple[list[trimesh.Trimesh], np.ndarray]:
...
def rails_terrain(
    difficulty: float, cfg: basic_mesh_terrains_cfg.MeshRailsTerrainCfg
) -> tuple[list[trimesh.Trimesh], np.ndarray]:
...
def pit_terrain(
    difficulty: float, cfg: basic_mesh_terrains_cfg.MeshPitTerrainCfg
) -> tuple[list[trimesh.Trimesh], np.ndarray]:
...
def box_terrain(
    difficulty: float, cfg: basic_mesh_terrains_cfg.MeshBoxTerrainCfg
) -> tuple[list[trimesh.Trimesh], np.ndarray]:
...
def gap_terrain(
    difficulty: float, cfg: basic_mesh_terrains_cfg.MeshGapTerrainCfg
) -> tuple[list[trimesh.Trimesh], np.ndarray]:
...
def floating_ring_terrain(
    difficulty: float, cfg: basic_mesh_terrains_cfg.MeshFloatingRingTerrainCfg
) -> tuple[list[trimesh.Trimesh], np.ndarray]:
...
def star_terrain(
    difficulty: float, cfg: basic_mesh_terrains_cfg.MeshStarTerrainCfg
) -> tuple[list[trimesh.Trimesh], np.ndarray]:
