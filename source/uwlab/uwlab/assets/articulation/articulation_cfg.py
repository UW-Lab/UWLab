...
from .articulation import UniversalArticulation
from .articulation_view import ArticulationViewCfg
...
class ArticulationCfg(AssetBaseCfg):
    ...
    class_type: type[UniversalArticulation] = UniversalArticulation

    articulation_view_cfg: ArticulationViewCfg = MISSING
