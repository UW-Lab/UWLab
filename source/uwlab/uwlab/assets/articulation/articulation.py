...
class UniversalArticulation(AssetBase):
    ...
    attribute. They are used to compute the joint commands during the :meth:`write_data_to_view` function.
    """
    ...
    def is_fixed_base(self) -> bool:
        ...
        return self.view.fixed_base

    @property
    def num_joints(self) -> int:
        """Number of joints in articulation."""
        return self.view.dof_count

    @property
    def num_fixed_tendons(self) -> int:
        """Number of fixed tendons in articulation."""
        return self.view.max_fixed_tendons
    ...
    def body_names(self) -> list[str]:
        ...
        return self.view.body_names

    @property
    def view(self) -> ArticulationView:
    ...
    def write_data_to_sim(self):
        ...
        self.view.set_dof_actuation_forces(self._joint_effort_target_sim, self._ALL_INDICES)
        # position and velocity targets only for implicit actuators
        if self._has_implicit_actuators:
            self.view.set_dof_position_targets(self._joint_pos_target_sim, self._ALL_INDICES)
            self.view.set_dof_velocity_targets(self._joint_vel_target_sim, self._ALL_INDICES)
    ...
    def write_root_state_to_sim(self, root_state: torch.Tensor, env_ids: Sequence[int] | None = None):
        ...
        if not self._root_state_dep_warn:
            omni.log.warn(
                "DeprecationWarning: Articluation.write_root_state_to_view will be removed in a future release. Please"
                " use write_root_link_state_to_view or write_root_com_state_to_view instead."
            )
    ...
    def write_root_pose_to_sim(self, root_pose: torch.Tensor, env_ids: Sequence[int] | None = None):
        ...
        if not self._root_pose_dep_warn:
            omni.log.warn(
                "DeprecationWarning: Articluation.write_root_pos_to_view will be removed in a future release. Please"
                " use write_root_link_pose_to_view or write_root_com_pose_to_view instead."
            )
    ...
    def write_root_link_pose_to_sim(self, root_pose: torch.Tensor, env_ids: Sequence[int] | None = None):
        ...
        # set into simulation
        self.view.set_root_transforms(root_poses_xyzw, indices=physx_env_ids)
    ...
    def write_root_velocity_to_sim(self, root_velocity: torch.Tensor, env_ids: Sequence[int] | None = None):
        ...
        if not self._root_vel_dep_warn:
            omni.log.warn(
                "DeprecationWarning: Articluation.write_root_velocity_to_view will be removed in a future release."
                " Please use write_root_link_velocity_to_view or write_root_com_velocity_to_view instead."
            )
    ...
    def write_root_com_velocity_to_sim(self, root_velocity: torch.Tensor, env_ids: Sequence[int] | None = None):
        ...
        # set into simulation
        self.view.set_root_velocities(self._data.root_com_state_w[:, 7:], indices=physx_env_ids)
    ...
    def write_joint_state_to_sim(
        ...
        self._data._body_com_state_w.timestamp = -1.0
        # set into simulation
        self.view.set_dof_positions(self._data.joint_pos, indices=physx_env_ids)
        self.view.set_dof_velocities(self._data.joint_vel, indices=physx_env_ids)
    ...
    def write_joint_stiffness_to_sim(
        ...
        # set into simulation
        self.view.set_dof_stiffnesses(self._data.joint_stiffness.cpu(), indices=physx_env_ids.cpu())
    ...
    def write_joint_damping_to_sim(
        ...
        # set into simulation
        self.view.set_dof_dampings(self._data.joint_damping.cpu(), indices=physx_env_ids.cpu())
    ...
    def write_joint_velocity_limit_to_sim(
        ...
        # set into internal buffers
        self._data.joint_vel_limits = self.view.get_dof_max_velocities().to(self.device)
        self._data.joint_vel_limits[env_ids, joint_ids] = limits
        # set into simulation
        self.view.set_dof_max_velocities(self._data.joint_vel_limits.cpu(), indices=physx_env_ids.cpu())
    ...
    def write_joint_effort_limit_to_sim(
        ...
        if isinstance(limits, torch.Tensor):
            limits = limits.cpu()
        # set into internal buffers
        torque_limit_all = self.view.get_dof_max_forces()
        torque_limit_all[env_ids, joint_ids] = limits
        # set into simulation
        self.view.set_dof_max_forces(torque_limit_all.cpu(), indices=physx_env_ids.cpu())
    ...
    def write_joint_armature_to_sim(
        ...
        # set into simulation
        self.view.set_dof_armatures(self._data.joint_armature.cpu(), indices=physx_env_ids.cpu())
    ...
    def write_joint_friction_to_sim(
        ...
        # set into simulation
        self.view.set_dof_friction_coefficients(self._data.joint_friction.cpu(), indices=physx_env_ids.cpu())
    ...
    def write_joint_limits_to_sim(
        ...
        # set into simulation
        self.view.set_dof_limits(self._data.joint_limits.cpu(), indices=physx_env_ids.cpu())
    ...
    def set_external_force_and_torque(
        ...
        .. note::
            ...
            the desired values. To apply the external wrench, call the :meth:`write_data_to_view` function
        ...
        if forces.any() or torques.any():
            ...
            # set into internal buffers
            # note: these are applied in the write_to_view function
    ...
    def set_joint_position_target(
        ...
        .. note::
            ...
            the desired values. To apply the joint targets, call the :meth:`write_data_to_view` function.
    ...
    def set_fixed_tendon_stiffness(
        ...
        .. note::
            ...
            the desired values. To apply the tendon stiffness, call the :meth:`write_fixed_tendon_properties_to_view` function.
    ...
    def set_fixed_tendon_damping(
        ...
        .. note::
            ...
            the desired values. To apply the tendon damping, call the :meth:`write_fixed_tendon_properties_to_view` function.
    ...
    def set_fixed_tendon_limit_stiffness(
        ...
        .. note::
            ...
            the desired values. To apply the tendon limit stiffness, call the :meth:`write_fixed_tendon_properties_to_view` function.
    ...
    def set_fixed_tendon_limit(
        ...
        .. note::
             ...
             the desired values. To apply the tendon limit, call the :meth:`write_fixed_tendon_properties_to_view` function.
    ...
    def set_fixed_tendon_rest_length(
        ...
        .. note::
            ...
            the desired values. To apply the tendon rest length, call the :meth:`write_fixed_tendon_properties_to_view` function.
    ...
    def set_fixed_tendon_offset(
        ...
        .. note::
            ...
            the desired values. To apply the tendon offset, call the :meth:`write_fixed_tendon_properties_to_view` function.
    ...
    def write_fixed_tendon_properties_to_sim(
        ...
        # set into simulation
        self.view.set_fixed_tendon_properties(
    ...
    def _initialize_impl(self, device: str = None):
        # create simulation view
        self._device = device if device else "cpu"
        self._view: ArticulationView = self.cfg.articulation_view_cfg.class_type(
            cfg=self.cfg.articulation_view_cfg, device=self.device
        )

        # log information about the articulation
        print(f"Is fixed root: {self.is_fixed_base}")
        ...
        self._data = ArticulationData(self.view, self.device)
    ...
    def initialize_default_data(self):
        ...
        self._view.set_dof_position_targets(self._data.joint_pos_target, indices=self._ALL_INDICES)
        self._view.set_dof_velocity_targets(self._data.joint_vel_target, indices=self._ALL_INDICES)
    ...
    def _create_buffers(self):
        ...
        # -- bodies
        self._data.default_mass = self.view.get_masses().clone()
        self._data.default_inertia = self.view.get_inertias().clone()
        ...
        joint_pos_limits = self.view.get_dof_limits()
    ...
    def _process_cfg(self):
        ...
        # -- joint limits
        self._data.default_joint_limits = self.view.get_dof_limits().to(device=self.device).clone()
    ...
    def _process_actuators_cfg(self):
        ...
        self._data.default_joint_stiffness = self.view.get_dof_stiffnesses().to(self.device).clone()
        self._data.default_joint_damping = self.view.get_dof_dampings().to(self.device).clone()
        self._data.default_joint_armature = self.view.get_dof_armatures().to(self.device).clone()
        self._data.default_joint_friction = self.view.get_dof_friction_coefficients().to(self.device).clone()
        ...
        for actuator_name, actuator_cfg in self.cfg.actuators.items():
            ...
            actuator: ActuatorBase = actuator_cfg.class_type(
                ...
                effort_limit=self.view.get_dof_max_forces().to(self.device).clone()[:, joint_ids],
    ...
    def _process_fixed_tendons(self):
        ...
        if self.num_fixed_tendons > 0:
            ...
            joint_paths = self.view.dof_paths[0]
            ...
            self._data.default_fixed_tendon_stiffness = self.view.get_fixed_tendon_stiffnesses().clone()
            self._data.default_fixed_tendon_damping = self.view.get_fixed_tendon_dampings().clone()
            self._data.default_fixed_tendon_limit_stiffness = self.view.get_fixed_tendon_limit_stiffnesses().clone()
            self._data.default_fixed_tendon_limit = self.view.get_fixed_tendon_limits().clone()
            self._data.default_fixed_tendon_rest_length = self.view.get_fixed_tendon_rest_lengths().clone()
            self._data.default_fixed_tendon_offset = self.view.get_fixed_tendon_offsets().clone()
    ...
    def _validate_cfg(self):
        ...
        joint_pos_limits = self.view.get_dof_limits()[0].to(self.device)
        ...
        joint_max_vel = self.view.get_dof_max_velocities()[0].to(self.device)
    ...
    def _log_articulation_joint_info(self):
        ...
        # -- gains
        stiffnesses = self.view.get_dof_stiffnesses()[0].tolist()
        dampings = self.view.get_dof_dampings()[0].tolist()
        # -- properties
        armatures = self.view.get_dof_armatures()[0].tolist()
        frictions = self.view.get_dof_friction_coefficients()[0].tolist()
        # -- limits
        position_limits = self.view.get_dof_limits()[0].tolist()
        velocity_limits = self.view.get_dof_max_velocities()[0].tolist()
        effort_limits = self.view.get_dof_max_forces()[0].tolist()
        ...
        if self.num_fixed_tendons > 0:
            # -- gains
            ft_stiffnesses = self.view.get_fixed_tendon_stiffnesses()[0].tolist()
            ft_dampings = self.view.get_fixed_tendon_dampings()[0].tolist()
            # -- limits
            ft_limit_stiffnesses = self.view.get_fixed_tendon_limit_stiffnesses()[0].tolist()
            ft_limits = self.view.get_fixed_tendon_limits()[0].tolist()
            ft_rest_lengths = self.view.get_fixed_tendon_rest_lengths()[0].tolist()
            ft_offsets = self.view.get_fixed_tendon_offsets()[0].tolist()
            # create table for term information
