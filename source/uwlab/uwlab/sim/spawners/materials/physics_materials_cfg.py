# Copyright (c) 2022-2024, The UW Lab and Isaac Lab Project Developers.
# All rights reserved.
...
@configclass
class StageSpecificRigidBodyMaterialCfg(PhysicsMaterialCfg):
    ...
    func: Callable = physics_materials.stage_specific_spawn_rigid_body_material
...
@configclass
class StageSpecificDeformableBodyMaterialCfg(PhysicsMaterialCfg):
    ...
    func: Callable = physics_materials.stage_specific_spawn_deformable_body_material
