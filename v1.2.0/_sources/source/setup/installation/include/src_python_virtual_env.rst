...
Creating a dedicated Python environment for UW Lab is **strongly recommended**, even though
...
instead of *./uwlab.sh -p* or *uwlab.bat -p*.
...
.. tab-set::
   ...
   .. tab-item::  UV Environment
      ...
      You can create the UW Lab environment using the following commands:
      ...
      .. tab-set::
         ...
         .. tab-item:: :icon:`fa-brands fa-linux` Linux
            ...
            .. code:: bash
               ...
               # Option 1: Default environment name 'env_uwlab'
               ./uwlab.sh --uv  # or "./uwlab.sh -u"
               # Option 2: Custom name
               ./uwlab.sh --uv my_env  # or "./uwlab.sh -u my_env"

            .. code:: bash

               # Activate environment
               source ./env_uwlab/bin/activate  # or "source ./my_env/bin/activate"
      ...
      .. tab-set::
         ...
         .. tab-item:: :icon:`fa-brands fa-linux` Linux
            ...
            .. code:: bash
               ...
               # Option 1: Default environment name 'env_uwlab'
               ./uwlab.sh --conda  # or "./uwlab.sh -c"
               # Option 2: Custom name
               ./uwlab.sh --conda my_env  # or "./uwlab.sh -c my_env"

            .. code:: bash

               # Activate environment
               conda activate env_uwlab  # or "conda activate my_env"
         ...
         .. tab-item:: :icon:`fa-brands fa-windows` Windows
            ...
            .. code:: batch
               ...
               :: Option 1: Default environment name 'env_uwlab'
               uwlab.bat --conda  :: or "uwlab.bat -c"
               :: Option 2: Custom name
               uwlab.bat --conda my_env  :: or "uwlab.bat -c my_env"
...
Once you are in the virtual environment, you do not need to use ``./uwlab.sh -p`` or
``uwlab.bat -p`` to run python scripts. You can use the default python executable in your
environment by running ``python`` or ``python3``. However, for the rest of the documentation,
we will assume that you are using ``./uwlab.sh -p`` or ``uwlab.bat -p`` to run python scripts.
